...
actual class StompCommunicationChannel : CommunicationChannel {

    private val serverHandler = StompServerHandler()
    private val clientHandler = StompClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.STOMP
