...
actual class GrpcCommunicationChannel actual constructor() : CommunicationChannel {

    private val serverHandler = GrpcServerHandler()
    private val clientHandler = GrpcClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.GRPC
