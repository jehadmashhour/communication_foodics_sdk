...
actual class MDNSCommunicationChannel actual constructor(serviceType: String) : CommunicationChannel {

    private val serverHandler = MDNSServerHandler(serviceType)
    private val clientHandler = MDNSClientHandler(serviceType)

    actual override val connectionType: ConnectionType = ConnectionType.MDNS
