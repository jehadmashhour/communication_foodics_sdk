...
actual class MQTTCommunicationChannel actual constructor(brokerUrl: String) : CommunicationChannel {

    val serverHandler = MQTTServerHandler(brokerUrl)
    val clientHandler = MQTTClientHandler(brokerUrl)

    actual override val connectionType: ConnectionType = ConnectionType.MQTT
