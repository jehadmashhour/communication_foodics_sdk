...
actual class NFCCommunicationChannel : CommunicationChannel {

    val serverHandler = NFCServerHandler()
    val clientHandler = NFCClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.NFC
