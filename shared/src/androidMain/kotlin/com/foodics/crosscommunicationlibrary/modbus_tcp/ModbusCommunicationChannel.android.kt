...
actual class ModbusCommunicationChannel actual constructor() : CommunicationChannel {

    private val serverHandler = ModbusServerHandler()
    private val clientHandler = ModbusClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.MODBUS_TCP
