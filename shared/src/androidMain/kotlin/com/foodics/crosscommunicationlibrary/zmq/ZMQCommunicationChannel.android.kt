...
actual class ZMQCommunicationChannel actual constructor() : CommunicationChannel {

    private val serverHandler = ZMQServerHandler()
    private val clientHandler = ZMQClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.ZMQ
