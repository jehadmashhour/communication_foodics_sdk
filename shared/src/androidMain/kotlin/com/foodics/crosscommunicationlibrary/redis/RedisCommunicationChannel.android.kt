...
actual class RedisCommunicationChannel actual constructor(
    private val brokerUrl: String
) : CommunicationChannel {

    private val serverHandler = RedisServerHandler(brokerUrl)
    private val clientHandler = RedisClientHandler(brokerUrl)

    actual override val connectionType: ConnectionType = ConnectionType.REDIS
