...
actual class TcpCommunicationChannel : CommunicationChannel {

    private val serverHandler = TcpServerHandler()
    private val clientHandler = TcpClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.TCP_SOCKET
