...
actual class WebRTCCommunicationChannel : CommunicationChannel {

    private val serverHandler = WebRTCServerHandler()
    private val clientHandler = WebRTCClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.WEBRTC
    ...
    actual override suspend fun connectToServer(device: IoTDevice) =
        clientHandler.connect(device.id ?: "")
