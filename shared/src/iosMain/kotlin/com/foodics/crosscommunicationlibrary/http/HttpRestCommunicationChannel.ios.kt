...
actual class HttpRestCommunicationChannel : CommunicationChannel {

    private val serverHandler = HttpRestServerHandler()
    private val clientHandler = HttpRestClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.HTTP_REST
