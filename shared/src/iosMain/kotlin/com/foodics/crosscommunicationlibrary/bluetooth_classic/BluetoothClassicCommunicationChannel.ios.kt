...
actual class BluetoothClassicCommunicationChannel : CommunicationChannel {

    private val serverHandler = BluetoothClassicServerHandler()
    private val clientHandler = BluetoothClassicClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.BLUETOOTH_CLASSIC
