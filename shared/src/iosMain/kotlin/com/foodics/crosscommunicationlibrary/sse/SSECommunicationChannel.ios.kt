...
actual class SSECommunicationChannel : CommunicationChannel {

    private val serverHandler = SSEServerHandler()
    private val clientHandler = SSEClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.SSE
