...
actual class MulticastCommunicationChannel : CommunicationChannel {

    private val serverHandler = MulticastServerHandler()
    private val clientHandler = MulticastClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.MULTICAST
