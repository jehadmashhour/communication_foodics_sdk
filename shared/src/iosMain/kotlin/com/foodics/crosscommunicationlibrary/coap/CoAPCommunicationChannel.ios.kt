...
actual class CoAPCommunicationChannel : CommunicationChannel {

    private val serverHandler = CoAPServerHandler()
    private val clientHandler = CoAPClientHandler()

    actual override val connectionType: ConnectionType = ConnectionType.COAP
